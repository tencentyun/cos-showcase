const agenda = [
  ...
  },
  {
    ...
    speaker: '王银虎',
    speaker_intro: '腾讯TEG技术工程事业群云硬盘专家工程师',
    keywords: '性能'
  },
  {
    id: 2,
    ...
    endTime: '15:50',
    title: '大数据存储上云，快人一步',
    summary: '随着云计算技术不断深入普及，大数据分析技术也在发生着巨大的转型。传统的存储和计算混布的架构也正一步一步朝着存储和计算分离的架构发生着演变。存储和计算分离的架构带来了架构的解耦的便利性的同时，也降低了整体大数据分析的资源成本。腾讯云存储团队提供的云HDFS产品，提供一种标准 HDFS 访问协议、卓越性能、分层命名空间的分布式文件系统。通过方便快捷的云HDFS托管海量文件，使得用户更加关注业务本身，更加高扩展性、低成本、安全可靠的进行大数据分析。',
    speaker: '严俊明',
