const agenda = [
  {
    ...
    speaker: '谢长生教授',
    speaker_intro: '华中科技大学计算机学院教授，博士生导师。现任武汉光电国家实验室（筹）副主任，“信息存储系统”教育部重点实验室主任，信息存储与数字媒体实验室主任、兼任中国计算机学会外围设备专业委员会副主任，信息存储专委会常委，国际网络存储工业协会（SNIA）中国区专家委员会副主席。',
    keywords: '性能'
  },
  {
    id: 1,
    ...
    speaker: 'kevinnma(马文霜)',
    speaker_intro: 'CSIG计算产品中心',
    keywords: '性能'
  },
  {
    id: 2,
    ...
    summary: '随着物联网、5G、人工智能等新技术、新平台、新应用的日新月异，正促使着数据存储技术的深度变革。特别是，新型非易失存储器件如3D XPoint、PCM等快速的发展，对构建持久性内存存储系统带来了机遇；存储接口NVMe以及网络传输RDMA的发展，正促使存储系统软件架构发生深度变革，也给存储系统的构建带来了新的挑战和机遇。特邀国内学术界专家谢长生教授莅临大会分论坛现场，与观众展开深入交流。',
    speaker: 'TBD',
    speaker_intro: '随着云计算技术不断深入普及，大数据分析技术也在发生着巨大的转型。传统的存储和计算混布的架构也正一步一步朝着存储和计算分离的架构发生着演变。存储和计算分离的架构带来了架构的解耦的便利性的同时，也降低了整体大数据分析的资源成本。腾讯云存储团队提供的云HDFS产品，提供一种标准 HDFS 访问协议、卓越性能、分层命名空间的分布式文件系统。通过方便快捷的云HDFS托管海量文件，使得用户更加关注业务本身，更加高扩展性、低成本、安全可靠的进行大数据分析。',
    keywords: '性能'
  },
  {
    id: 3,
  ...
  },
  {
    ...
    speaker: '孙云清',
    speaker_intro: 'TEG技术工程事业群/基础架构部/社交业务中心/图片业务组',
    keywords: '性能'
  }
];
